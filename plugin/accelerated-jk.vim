...
noremap <silent><Plug>(accelerated_po_gj) :<C-u>call accelerated#position_driven#command('gj')<CR>
noremap <silent><Plug>(accelerated_po_gk) :<C-u>call accelerated#position_driven#command('gk')<CR>
noremap <silent><Plug>(accelerated_po_j)  :<C-u>call accelerated#position_driven#command('j')<CR>
noremap <silent><Plug>(accelerated_po_k)  :<C-u>call accelerated#position_driven#command('k')<CR>
noremap <silent><Plug>(accelerated_po_l)  :<C-u>call accelerated#position_driven#command('l')<CR>
noremap <silent><Plug>(accelerated_po_h)  :<C-u>call accelerated#position_driven#command('k')<CR>
"}}}
